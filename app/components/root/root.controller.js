module.exports = {
    ...
    post: function(req, res) {
        try {
            ...
            return global.succes(res, {data: {message: "Usuario recibido"}, statusCode: 201});
        } catch (error) {
    ...
    put: function(req, res) {
        try {
            ...
            return global.succes(res, {data: {message: "Usuario actualizado"}, statusCode: 200});
        } catch (error) {
            return global.error(res, {error: error.message, statusCode: 401});
        }        
    },
    delete: function(req, res) {
        try {
            const {id} = req.params;
            console.log(id);
            return global.succes(res, {data: {message: "Usuario eliminado"}, statusCode: 204});
        } catch (error) {
            return global.error(res, {error: error.message, statusCode: 401});
        }       
    },
